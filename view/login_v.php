<?php
class login_v extends page_v
{
    private $ajax_login_v;
    function __construct()
    {
        $this->ajax_login_v=new ajax_login_v();
        parent::__construct("login","Please log in");
    }
    function addToInput($key, $value)
    {
        $this->ajax_login_v->addToInput($key,$value);
    ...
    {
        ?>
        <script type="text/javascript" src="assets/elearning/login.js"></script>
        <?php
    }
    function wrapper()
    {
